...
$array = array(
    ...
    array(
        "job_tiile"     => "Web Developer / something.com",
        "date"          => "Mar 2012 - Dec 2014",
        "description"   => "Consectetur adipisicing elit. Praesentium magnam consectetur vel
                            in deserunt aspernatur est reprehenderit sunt hic. Nulla tempora 
                            soluta ea et odio, unde doloremque repellendus iure, iste."
        ),
    array(
        "job_tiile"     => "Graphic Designer / designsomething.com",
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $array[0]["job_tiile"]; ?></b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $array[0]["date"]; ?><span
                class="w3-tag w3-teal w3-round">Current</span></h6>
            <p><?php echo $array[0]["description"]; ?></p>
            <hr>
          </div>
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $array[1]["job_tiile"]; ?></b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $array[1]["date"]; ?></h6>
            <p><?php echo $array[1]["description"]; ?></p>
            <hr>
          </div>
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $array[2]["job_tiile"]; ?></b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $array[2]["date"]; ?></h6>
            <p><?php echo $array[2]["description"]; ?></p><br>
          </div>
        </div>
